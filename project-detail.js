...
const detailNarratives = {
  "minimum-wage-unemployment": {
    ...
    body: `
      ...
      <p>In this equation, the interaction term is the policy signal of interest, county fixed effects capture time-invariant local differences, time fixed effects absorb common shocks, and the lag term captures persistence in unemployment itself. The equation looks simple, but each term corresponds to a specific modeling choice about what we are willing to treat as part of the counterfactual.</p>
  ...
  "natural-gas-consumption-forecasting": {
    ...
    body: `
      ...
      <h2>Data and model comparison</h2>
  ...
  "champaign-rental-price-forecasting": {
    ...
    body: `
      ...
      <h2>Data engineering and setup</h2>
  ...
  "conversion-rate-modeling-optimization": {
    ...
    body: `
      ...
      <h2>Data and business framing</h2>
      ...
      <div class="math-block">\\[ F_1 = \\frac{2 \\cdot \\mathrm{Precision} \\cdot \\mathrm{Recall}}{\\mathrm{Precision} + \\mathrm{Recall}}. \\]</div>
