const siteData = {
  ...
  homeAbout: [
    ...
    'Before Penn, I studied Statistics and Economics at the University of Illinois Urbana-Champaign, with minors in Mathematics and Computer Science. During the summer of 2023, I joined <a href="https://jkcshea.github.io/" target="_blank" rel="noreferrer">Prof. Joshua Shea</a>\'s undergraduate research group and began working on the relationship between gender ratios and female labor force participation, using instrumental variables, panel data methods, and 2SLS to build a causal argument rather than a merely correlational one. In Fall 2024, I became a URES Fellow under <a href="https://experts.illinois.edu/en/persons/hyoeun-lee/" target="_blank" rel="noreferrer">Prof. Hyoeun Lee</a>, where I worked on forecasting the Champaign rental market using large-scale housing, demographic, and macroeconomic data with time-series and machine learning models. During the same period, I joined the <a href="https://publish.illinois.edu/econdatalab/people/" target="_blank" rel="noreferrer">UIUC Economics Data Lab</a> under <a href="https://economics.illinois.edu/profile/dafontes" target="_blank" rel="noreferrer">Prof. Daniela Fontes</a> to replicate and extend a macro-forecasting paper by Prof. Marcelo Medeiros, which deepened my understanding of high-dimensional prediction, shrinkage methods, and data-rich econometrics.',
    'In Summer 2024, I also worked as a research assistant for <a href="https://www.songlena.com/" target="_blank" rel="noreferrer">Prof. Lena Song</a>, where I built large-scale Reddit datasets, designed event-study style analyses around the launches of ChatGPT and GPT-4, and supported experimental work on AI content detection and online discourse. Across these projects, I developed a strong foundation in causal inference and empirical economics, especially in thinking carefully about identification, robustness, and whether a result is credible enough to support an actual claim. I graduated from UIUC in Spring 2025 with the university\'s Bronze Tablet distinction and Summa Cum Laude honors. Along the way, I built a technical base across statistical learning, Bayesian analysis, time series, causal inference, design of experiments, econometrics, databases, algorithms, deep learning, and computer vision.',
    "I have learned that a data scientist's edge comes less from one more sophisticated model than from a sharper understanding of the business itself, which is why I have consistently pursued internships to build product instinct and commercial judgment alongside technical depth.",
...
const assetVersion = "20260405-home-tabs-14";
