const siteData = {
  ...
  homeAbout: [
    ...
    'Before Penn, I studied Statistics and Economics at the University of Illinois Urbana-Champaign, with minors in Mathematics and Computer Science. Along the way, I built a technical base across statistical learning, Bayesian analysis, time series, causal inference, design of experiments, econometrics, databases, algorithms, deep learning, and computer vision. In Summer 2023, I joined <a href="https://jkcshea.github.io/" target="_blank" rel="noreferrer">Prof. Joshua Shea</a>\'s undergraduate research group and began studying the relationship between gender ratios and female labor force participation using instrumental variables, panel data methods, and 2SLS. In Summer 2024, I worked as a research assistant for <a href="https://www.songlena.com/" target="_blank" rel="noreferrer">Prof. Lena Song</a>, where I built large-scale Reddit datasets, designed event-study style analyses around the launches of ChatGPT and GPT-4, and supported experimental work on AI content detection and online discourse. In Fall 2024, I became a URES Fellow under <a href="https://experts.illinois.edu/en/persons/hyoeun-lee/" target="_blank" rel="noreferrer">Prof. Hyoeun Lee</a>, forecasting the Champaign rental market with large-scale housing, demographic, and macroeconomic data and a mix of time-series and machine learning models, while also joining the <a href="https://publish.illinois.edu/econdatalab/people/" target="_blank" rel="noreferrer">UIUC Economics Data Lab</a> under <a href="https://economics.illinois.edu/profile/dafontes" target="_blank" rel="noreferrer">Prof. Daniela Fontes</a> to replicate and extend a macro-forecasting paper by Prof. Marcelo Medeiros. In Spring 2025, under <a href="https://sites.google.com/a/illinois.edu/eunyichung/" target="_blank" rel="noreferrer">Prof. EunYi Chung</a>, I studied the effect of minimum wage shocks on unemployment using difference-in-differences and TWFE, with placebo tests and parallel-trend diagnostics to stress-test the identification strategy. Across these projects, I built a strong foundation in causal inference and empirical economics and graduated from UIUC with Bronze Tablet distinction and Summa Cum Laude honors.',
...
const assetVersion = "20260405-home-tabs-15";
