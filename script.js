...
const siteDataZh = {
  ...
  homeAbout: [
    ...
    '我正在积极寻找 <span class="focus-emphasis">industry</span> 或 <span class="focus-emphasis">research</span> 方向机会，主要关注：<span class="about-focus-list"><span><span class="focus-role">Product Data Science：</span>围绕实验、漏斗与留存分析、dashboarding 和指标设计，支持增长、商业化和用户行为决策。</span><span><span class="focus-role">Modeling Data Science：</span>关注预测建模、检索与评估 pipeline、LLM 应用层工作流，以及面向不确定场景下更安全 agent 行为的 RL-based alignment。</span><span><span class="focus-role">AI、Computational Social Science 与 Policy Analytics：</span>关注 LLM-assisted measurement、因果推断、问卷实验，以及劳动和住房等社会科学问题中现代 AI 方法与社会证据的结合。</span></span>',
...
const assetVersion = "20260524-about-focus-0007";
