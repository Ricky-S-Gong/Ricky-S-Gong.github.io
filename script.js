const siteData = {
  ...
  homeAbout: [
    ...
    "Outside of work, I enjoy guandan, hiking, cooking, exploring restaurants, and playing badminton. These parts of my life let me move across different rhythms and states of mind, and over time they have shaped the way I think about life. I have long believed that doing great work depends on more than technical ability alone: it comes from physical well-being, a genuine love of life, and the social process of learning how to relate to different kinds of people. Those things help me work better, stay open to the world, understand others more deeply, and know myself more clearly.",
  ],
  capabilities: [
    {
...
const siteDataZh = {
  ...
  homeAbout: [
    ...
    "我在工作之外喜欢掼蛋、徒步、做饭、探索餐厅，也会打羽毛球。这些事情让我在不同的节奏和状态中切换，也逐渐塑造了我的生活哲学。一直以来，我都相信，只有健康的体魄、对生活的热爱，以及与不同人相处的社会化过程，才能让我更出色地工作，也让我持续地感受世界、理解他人，并更清楚地认识自己。",
  ],
  research: [
    {
      title: "最低工资冲击对失业的影响",
...
const assetVersion = "20260406-home-tabs-109";
