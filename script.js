const siteData = {
  ...
  homeAbout: [
    ...
    'I am actively seeking industry or research roles where data science connects rigorous modeling with product, organizational, or social decisions.<span class="about-focus-list"><span><strong>Product data science:</strong> experimentation, funnel and retention analysis, dashboarding, and metric design for teams making growth, monetization, or user-behavior decisions.</span><span><strong>Modeling data science:</strong> predictive modeling, retrieval and evaluation pipelines, LLM application-layer workflows, and RL-based alignment for safer agent behavior under uncertainty.</span><span><strong>Computational social science and policy analytics:</strong> causal inference, survey experiments, labor and housing questions, and empirical work that connects statistical evidence to human outcomes.</span></span>',
...
const siteDataZh = {
  ...
  homeAbout: [
    '你好 😉 我是宫商羽，你也可以叫我 Ricky。我目前在宾夕法尼亚大学攻读 <a href="https://dats.seas.upenn.edu/" target="_blank" rel="noreferrer">数据科学硕士</a>。在 Penn 之前，我在伊利诺伊大学厄巴纳-香槟分校以<a href="https://stat.illinois.edu/" target="_blank" rel="noreferrer">统计学</a>与<a href="https://economics.illinois.edu/" target="_blank" rel="noreferrer">经济学</a>双主修获得本科学位，并辅修<a href="https://math.illinois.edu/" target="_blank" rel="noreferrer">数学</a>和<a href="https://siebelschool.illinois.edu/" target="_blank" rel="noreferrer">计算机科学</a>；我本科阶段的大部分研究也主要围绕经济学问题展开，涵盖劳动、住房和政策分析。与 <a href="https://jkcshea.github.io/" target="_blank" rel="noreferrer">Joshua Shea 教授</a>、<a href="https://www.songlena.com/" target="_blank" rel="noreferrer">Lena Song 教授</a>、<a href="https://experts.illinois.edu/en/persons/hyoeun-lee/" target="_blank" rel="noreferrer">Hyoeun Lee 教授</a>、<a href="https://economics.illinois.edu/profile/dafontes" target="_blank" rel="noreferrer">Daniela Fontes 教授</a> 和 <a href="https://sites.google.com/a/illinois.edu/eunyichung/" target="_blank" rel="noreferrer">EunYi Chung 教授</a> 的合作，也塑造了我理解数据与研究的视角。我以 UIUC <a href="https://digital.library.illinois.edu/collections/81101fb0-e3fb-012f-c5b6-0019b9e633c5-5" target="_blank" rel="noreferrer">Bronze Tablet Scholar</a> 及 Summa Cum Laude 毕业。',
    '我正在积极寻找能够把严谨建模与产品、组织或社会决策连接起来的 industry / research 方向机会。<span class="about-focus-list"><span><strong>Product Data Science：</strong>围绕实验、漏斗与留存分析、dashboarding 和指标设计，支持增长、商业化和用户行为决策。</span><span><strong>Modeling Data Science：</strong>关注预测建模、检索与评估 pipeline、LLM 应用层工作流，以及面向不确定场景下更安全 agent 行为的 RL-based alignment。</span><span><strong>Computational Social Science 与 Policy Analytics：</strong>结合因果推断、问卷实验、劳动与住房问题，把统计证据和真实社会结果连接起来。</span></span>',
...
const assetVersion = "20260524-about-focus-0003";
