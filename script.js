const siteData = {
  ...
  homeAbout: [
    ...
    'I am actively seeking industry or research roles where data science connects rigorous modeling with product, organizational, or social decisions.<span class="about-focus-list"><span>Product data science: experimentation, funnel and retention analysis, dashboarding, and metric design for teams making growth, monetization, or user-behavior decisions.</span><span>Modeling data science and LLM systems: predictive modeling, retrieval and evaluation pipelines, tool-using language models, and applied ML systems that turn messy signals into reliable workflows.</span><span>Computational social science and policy analytics: causal inference, survey experiments, labor and housing questions, and empirical work that connects statistical evidence to human outcomes.</span></span>',
...
const siteDataZh = {
  ...
  homeAbout: [
    ...
    '我正在积极寻找能够把严谨建模与产品、组织或社会决策连接起来的 industry / research 方向机会。<span class="about-focus-list"><span>Product Data Science：围绕实验、漏斗与留存分析、dashboarding 和指标设计，支持增长、商业化和用户行为决策。</span><span>Modeling Data Science 与 LLM Systems：关注预测建模、检索与评估 pipeline、tool-using language models，以及把复杂信号转化为可靠工作流的应用机器学习系统。</span><span>Computational Social Science 与 Policy Analytics：结合因果推断、问卷实验、劳动与住房问题，把统计证据和真实社会结果连接起来。</span></span>',
...
const assetVersion = "20260524-about-focus-0001";
